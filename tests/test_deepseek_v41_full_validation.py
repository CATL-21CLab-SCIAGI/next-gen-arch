    ...
    def test_upgrade_rejects_model_or_runtime_drift(self):
        old = {
            ...
            "implementation_sha256": {
                "automodel/deepseek_v41_full_training.py": LEGACY_TRAINER_SHA256,
                "model.py": "model",
            },
        }
        new = copy.deepcopy(old)
        new["project_commit"] = "new"
        ...
        with self.assertRaisesRegex(ValueError, "protected"):
            admit_evaluation_upgrade(old, new, lambda: None)
