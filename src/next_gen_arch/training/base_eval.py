...
Examples:
    ...
    torchrun --nproc_per_node=8 -m next_gen_arch.training.base_eval --hf-path openai-community/gpt2

    # Evaluate a nanochat model (e.g. d24) using 8 GPUs
    torchrun --nproc_per_node=8 -m next_gen_arch.training.base_eval --model-tag d24 --device-batch-size=16
