...
def main():
    ...
    summary = {'snapshot_utc': now.isoformat(), 'matched_full_updates': matched,
               ...
               'evaluation': 'held-out evaluation is reported separately', 'variants': {}, 'sources': metadata}
    ...
    top.set_title('Full-weight fine-tuning: training-loss comparison',loc='left',pad=13,fontsize=14)
