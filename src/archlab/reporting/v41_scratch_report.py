...
def main():
    ...
    ratio=compare['normal']['supervised_tokens_per_second']/compare['simplicial']['supervised_tokens_per_second'];result={'generated_at_utc':datetime.now(timezone.utc).isoformat(),'health':health,'matched_throughput':compare,'normal_throughput_ratio':ratio,'job_id':'dlceswqa25tqudeo','job_name':'dlc-fcq-train-ds41w640d20-20260915-02','source_commit':'a948e476c06b066556b5b4d3fd425d25aa54104a'}
    ...
    lines=[f"Both reduced scratch-training variants passed sustained health checks through warmup at {health['utc']}. The current DLC job is **dlc-fcq-train-ds41w640d20-20260915-02**, ID **dlceswqa25tqudeo**, with one 8-B300 node per variant.",'',
