...
def main():
    ...
    report = {
        **runtime_identity(),
        ...
        "kv_heads": 2,
        "head_dim": 128,
        "window_including_current": 512,
        "query_positions": positions,
        "oracle": {},
    }
    for name, measured, oracle in zip(
        ("output", "dq", "dk", "dv"),
        (output[:, positions], *gradients),
        (expected, *oracle_gradients),
        strict=True,
    ):
        ...
        if relative >= 0.008 or not bool(measured.isfinite().all()):
