...
def build_model(base: Path, checkpoint: Path, config: SamplingConfig):
    ...
    from archlab.automodel.qwen.checkpointing import read_training_checkpoint
    from archlab.automodel.qwen.loading import (
        assert_loaded_weights_finite,
...
def main() -> None:
    ...
    from archlab.automodel.qwen.checkpointing import write_json
    from archlab.automodel.qwen.runtime import configure_frozen_gdn_runtime
    from archlab.automodel.qwen.simplicial import UPSTREAM_COMMIT
    ...
    source_checks = {}
    for name in ("archlab.automodel.qwen.simplicial", "archlab.architectures.simplicial_adapter",
                 "archlab.architectures.simplicial_attention", "archlab.automodel.qwen.loading"):
