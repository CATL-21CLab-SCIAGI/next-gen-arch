...
from archlab.architectures.base import GPT, ArchitectureRuntime, GPTConfig
from archlab.architectures.combinations import (
    ComboSearchConfig,
    ComboSearchGPT,
    ParetoComboConfig,
    ParetoComboGPT,
)
from archlab.architectures.dsa import DeepSeekDSA, DeepSeekDSAConfig
from archlab.architectures.fog import FOG, FOGConfig
from archlab.architectures.frontier import FrontierPoolConfig, FrontierPoolGPT
from archlab.architectures.kimi import KimiAttnRes, KimiAttnResConfig, KimiKDA, KimiKDAConfig
from archlab.architectures.sota import SotaPoolConfig, SotaPoolGPT
...
def patch_model_config_kwargs(model_config_kwargs: dict, *, runtime: ArchitectureRuntime | None = None) -> dict:
    ...
    patched.setdefault("runtime", runtime if runtime is not None else ArchitectureRuntime())
...
def build_model_config(
    *,
    ...
    common_kwargs = dict(
        ...
        runtime=runtime if runtime is not None else ArchitectureRuntime(),
    )
...
def build_model_from_config_kwargs(model_config_kwargs: dict, *, runtime_backend: str = "native", runtime: ArchitectureRuntime | None = None):
    patched = patch_model_config_kwargs(model_config_kwargs, runtime=runtime)
