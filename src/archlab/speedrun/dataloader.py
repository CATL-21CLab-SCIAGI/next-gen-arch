...
from archlab.fineweb import (
    FINEWEB_HEADER_BYTES as FINEWEB_HEADER_BYTES,
)
from archlab.fineweb import (
    FINEWEB_HEADER_INTS as FINEWEB_HEADER_INTS,
)
from archlab.fineweb import (
    FINEWEB_MAGIC as FINEWEB_MAGIC,
)
from archlab.fineweb import (
    FINEWEB_VERSION as FINEWEB_VERSION,
)
from archlab.fineweb import (
    FineWebBinaryLoader as FineWebBinaryLoader,
)
from archlab.fineweb import (
    inspect_fineweb_dataset as inspect_fineweb_dataset,
)
from archlab.fineweb import (
    inspect_fineweb_shard as inspect_fineweb_shard,
)
...
def tokenizing_distributed_data_loader_with_state_bos_bestfit(
    ...
    row_capacity = T + 1
    # New checkpoints carry an exact model-batch cursor. Rebuild the packing
    # stream from the beginning and deterministically replay to that cursor so
    # the buffered best-fit state is reconstructed exactly. Older checkpoints
    ...
    while True:
        ...
        if resume_batch_index is not None and batch_index < resume_batch_index:
            batch_index += 1
            continue
...
def tokenizing_distributed_data_loader_bos_bestfit(*args, **kwargs):
    ...
    for inputs, targets, _state_dict in tokenizing_distributed_data_loader_with_state_bos_bestfit(
        *args, **kwargs
    ):
