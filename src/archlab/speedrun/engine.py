...
from archlab.speedrun.runtime import autodetect_device_type, compute_init
...
class Engine:
    ...
    @torch.inference_mode()
    def generate(
        self, tokens, num_samples=1, max_tokens=None, temperature=1.0, top_k=None, seed=42
    ):
        ...
        def get_special(token: str) -> int:
            return self.tokenizer.encode_special(token)
